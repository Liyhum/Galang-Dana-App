...
import styles from "./tarikDanaStyle";
import {
  FontAwesome5,
  Ionicons,
...
//   console.log(hay, "safasf");
  ...
  const [refresh2, setRefres2] = useState(false);
    ...
    <View style={{ flex: 1, backgroundColor: "#e6f2ed", position: "relative" }}>
      <ScrollView>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.textTopup}>Tarik Dana</Text>
          <MaterialCommunityIcons
            name="menu"
            size={30}
            color="#e6f2ed"
